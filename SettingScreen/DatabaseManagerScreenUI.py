...
"border-width:2px")
        ...
        self.frame.setGeometry(QtCore.QRect(0, 0, 493, 373))
    ...
    def retranslateUi(self, Frame_containDatabaseScreen):
        ...
        __sortingEnabled = self.listWidget_showListStudent.isSortingEnabled()
        self.listWidget_showListStudent.setSortingEnabled(False)
        item = self.listWidget_showListStudent.item(0)
        item.setText(_translate("Frame_containDatabaseScreen", "New Item"))
        item = self.listWidget_showListStudent.item(1)
        item.setText(_translate("Frame_containDatabaseScreen", "New Item"))
        item = self.listWidget_showListStudent.item(2)
        item.setText(_translate("Frame_containDatabaseScreen", "New Item"))
